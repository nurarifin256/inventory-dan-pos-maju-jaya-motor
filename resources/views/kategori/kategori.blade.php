                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-kategori" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
...
<script>
    ...
    table = $('#table-kategori').DataTable({
        ...
        "order"       : [],
        "ajax"        : {
            "url" : "{{url('inventory/kategori/data_list')}}",
            "type": "POST",
            "headers": {
    ...
    $('.btn-add').on('click', function(){
        $.ajax({
            method: "get",
            url: `{{url('inventory/kategori/create')}}`,
            success: function(res){
    ...
    $("#table-kategori").on('click', '.action', function(){
        let data  = $(this).data();
        let id    = data.id;
        ...
        $.ajax({
            method: "get",
            url: `{{url('inventory/kategori')}}/${id}/edit`,
            success: function(res){
                $("#modalAction").find(".modal-dialog").html(res);
                modal.show();
                store()
