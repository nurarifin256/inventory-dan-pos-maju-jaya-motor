...
<script>
    ...
    table = $('#table-level').DataTable({
        ...
        "order"       : [],
        "ajax"        : {
            "url" : "{{url('inventory/level/data_list')}}",
            "type": "POST",
            "headers": {
    ...
    $('.btn-add').on('click', function(){
        $.ajax({
            method: "get",
            url: `{{url('inventory/level/create')}}`,
            success: function(res){
    ...
    $("#table-level").on('click', '.action', function(){
        let data  = $(this).data();
        let id    = data.id;
        ...
        $.ajax({
            method: "get",
            url: `{{url('inventory/level')}}/${id}/edit`,
            success: function(res){
                $("#modalAction").find(".modal-dialog").html(res);
                modal.show();
                store()
