                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between">
                            <div class="col-md-3">
                                @if (cekAkses(Auth::user()->id, "Locator", "tambah"))
                        ...
                        <div class="table-responsive">
                            <table id="table-locator" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nomor Rak</th>
...
<script>
    ...
    table = $('#table-locator').DataTable({
        ...
        "order"       : [],
        "ajax"        : {
            "url" : "{{url('inventory/locator/data_list')}}",
            "type": "POST",
            "headers": {
    ...
    $('.btn-add').on('click', function(){
        $.ajax({
            method: "get",
            url: `{{url('inventory/locator/create')}}`,
            success: function(res){
    ...
    $("#table-locator").on('click', '.action', function(){
        let data  = $(this).data();
        let id    = data.id;
