...
<script>
    ...
    table = $('#table-pelanggan').DataTable({
        ...
        "order"       : [],
        "ajax"        : {
            "url" : "{{url('pos/pelanggan/data_list')}}",
            "type": "POST",
            "headers": {
    ...
    $("#table-pelanggan").on('click', '.action', function(){
        let data  = $(this).data();
        let id    = data.id;
