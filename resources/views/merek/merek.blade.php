                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-merek" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
...
<script>
    ...
    table = $('#table-merek').DataTable({
        ...
        "order"       : [],
        "ajax"        : {
            "url" : "{{url('inventory/merek/data_list')}}",
            "type": "POST",
            "headers": {
    ...
    $('.btn-add').on('click', function(){
        $.ajax({
            method: "get",
            url: `{{url('inventory/merek/create')}}`,
            success: function(res){
    ...
    $("#table-merek").on('click', '.action', function(){
        let data  = $(this).data();
        let id    = data.id;
        ...
        $.ajax({
            method: "get",
            url: `{{url('inventory/merek')}}/${id}/edit`,
            success: function(res){
                $("#modalAction").find(".modal-dialog").html(res);
                modal.show();
                store()
